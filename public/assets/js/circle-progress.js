...
$(".circle-progress-kpi-warning-lg")
.circleProgress({
  startAngle: -Math.PI / 2 * 3,
  size: 64,
  lineCap: "round",
...
$(".circle-progress-kpi-secondary-lg")
.circleProgress({
  startAngle: -Math.PI / 2 * 3,
  size: 64,
  lineCap: "round",
...
$(".circle-progress-kpi-primary-lg")
.circleProgress({
  startAngle: -Math.PI / 2 * 3,
  size: 64,
  lineCap: "round",
...
$(".circle-progress-kpi-success-lg")
.circleProgress({
  startAngle: -Math.PI / 2 * 3,
  size: 64,
  lineCap: "round",
