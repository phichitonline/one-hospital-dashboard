...
@section('activemenu_resetpassword', 'mm-active')
...
@section('content')
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    Reset Password
                    <div class="page-title-subheading">ลืมรหัสผ่าน</div>
                </div>
            </div>
            <div class="page-title-actions">
                <button type="button" data-bs-toggle="tooltip" title="ลืมรหัสผ่าน"
    ...
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
        ...
        <li class="nav-item">
            <a role="tab" class="nav-link active" id="tab-1" data-bs-toggle="tab" href="#tab-forgotpassword">
                <span>Reset password</span>
            </a>
        </li>
        <li class="nav-item">
            <a role="tab" class="nav-link" id="tab-0" data-bs-toggle="tab" href="#tab-register">
                <span>Register</span>
            </a>
        </li>
    </ul>
    ...
    <div class="tab-content">
        <div class="tab-pane tabs-animation fade" id="tab-register" role="tabpanel">
                            ...
                            <div class="col-md-6">
                                <div class="position-relative mb-3">
                                    ...
                                    <input name="name" id="name"
                                        placeholder="ชื่อ-นามสกุล" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name">
                                    @error('name')
        ...
        <div class="tab-pane tabs-animation fade show active" id="tab-forgotpassword" role="tabpanel">
            <div class="main-card mb-3 card">
                <div class="card-body">
