...
@section('activemenu_login', 'mm-active')
...
@section('content')
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    Login
                    <div class="page-title-subheading">เข้าใช้งาน</div>
                </div>
            </div>
            <div class="page-title-actions">
                <button type="button" data-bs-toggle="tooltip" title="เข้าใช้งาน"
    ...
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
        <li class="nav-item">
            <a role="tab" class="nav-link active" id="tab-2" data-bs-toggle="tab" href="#tab-login">
                <span>Login</span>
            </a>
        </li>
        <li class="nav-item">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane tabs-animation fade show active" id="tab-login" role="tabpanel">
            <div class="main-card mb-3 card">
                <div class="card-body">
